...
/******/ 	var hotCurrentHash = "03dd3061264ce164fa1a"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsPostsBoardJsx = __webpack_require__(161);

	var _componentsPostsBoardJsx2 = _interopRequireDefault(_componentsPostsBoardJsx);

	var boardData = [{ author: 'John', date: '01/10/2015', text: 'Some  post', likes: 53, comments: [] }, { author: 'Stive', date: '01/10/2015', text: 'Some another post', likes: 25, comments: [] }, { author: 'Joy', date: '01/10/2015', text: 'Some important post', likes: 64, comments: [] }, { author: 'Jim', date: '01/10/2015', text: 'Some important post again', likes: 15, comments: [] }, { author: 'Yuriy', date: '01/10/2015', text: 'So important post', likes: 5, comments: [] }];

	_react2['default'].render(_react2['default'].createElement(_componentsPostsBoardJsx2['default'], { data: boardData }), document.getElementById('board-wrap'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactPropTypeLocationNames = __webpack_require__(33);
	var ReactCurrentOwner = __webpack_require__(13);
	var ReactNativeComponent = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMSelection = __webpack_require__(107);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BaseComponentJsx = __webpack_require__(38);

	var _BaseComponentJsx2 = _interopRequireDefault(_BaseComponentJsx);

	var _CommentListJsx = __webpack_require__(160);
	...
	var Post = (function (_BaseComponent) {
	  ...
	  _createClass(Post, [{
	    ...
	    key: '_onLikeClickHandler',
	    value: function _onLikeClickHandler() {
	      this.setState({
	    ...
	    key: '_onClickCommentButtonHandler',
	    value: function _onClickCommentButtonHandler() {
	      var commentText = this.commentText.getDOMNode().value;
	    ...
	    key: '_onCommentClickHandler',
	    value: function _onCommentClickHandler() {
	      this.setState({
	    ...
	    value: function render() {
	      ...
	      var author = _props$postData.author;
	      var date = _props$postData.date;
	      var text = _props$postData.text;

	      var addCommentArea = _react2['default'].createElement('div', null);

	      if (this.state.addCommentAreaActive) {
	        addCommentArea = _react2['default'].createElement(
	          'div',
	          { className: 'add-comment-area' },
	          _react2['default'].createElement('input', { ref: function (ref) {
	              return _this.commentText = ref;
	            }, placeholder: 'Your comment' }),
	          _react2['default'].createElement(
	            'button',
	            { onClick: this._onClickCommentButtonHandler },
	            'Comment'
	          )
	        );
	      }
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                'a',
	                { href: '#', onClick: this._onCommentClickHandler },
	                'Comment'
	              )
	            )
	          ),
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                'a',
	                { href: '#', onClick: this._onLikeClickHandler },
	                'Like'
	              ),
	              ' ',
	              this.state.likes
	        ...
	        addCommentArea,
	        _react2['default'].createElement(_CommentListJsx2['default'], { comments: this.state.comments })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutoFocusMixin = __webpack_require__(30);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventConstants = __webpack_require__(7);
	var LocalEventTrapMixin = __webpack_require__(42);
	var ReactBrowserComponentMixin = __webpack_require__(12);
	var ReactClass = __webpack_require__(8);
	var ReactElement = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactPutListenerQueue = __webpack_require__(70);
	var Transaction = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PostJsx = __webpack_require__(83);
	...
	var Comment = (function (_BaseComponent) {
	  ...
	  _createClass(Comment, [{
	    key: 'render',
	    value: function render() {
	      var _props$commentData = this.props.commentData;
	      var author = _props$commentData.author;
	      var date = _props$commentData.date;
	      var commentText = _props$commentData.commentText;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CommentJsx = __webpack_require__(159);

	var _CommentJsx2 = _interopRequireDefault(_CommentJsx);

	var CommentList = (function (_BaseComponent) {
	  _inherits(CommentList, _BaseComponent);
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        this.props.comments.map(function (comment, i) {
	          return _react2['default'].createElement(_CommentJsx2['default'], { commentData: comment, key: i });
	        })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PostsBoard = (function (_BaseComponent) {
	  _inherits(PostsBoard, _BaseComponent);

	  function PostsBoard(props) {
	    _classCallCheck(this, PostsBoard);

	    _get(Object.getPrototypeOf(PostsBoard.prototype), 'constructor', this).call(this, props);
	  ...
	  _createClass(PostsBoard, [{
	    ...
	    key: '_onAddPostClickHandler',
	    value: function _onAddPostClickHandler() {
	      var userText = this.userText.getDOMNode().value;
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'title' },
	          'React.JS posts board'
	        ),
	        _react2['default'].createElement(
	          'div',
	          { className: 'addpost-container' },
	          _react2['default'].createElement('input', { type: 'text', ref: function (ref) {
	              return _this.userText = ref;
	            }, className: 'addpost-input', placeholder: 'Enter the text...' }),
	          _react2['default'].createElement(
	            'button',
	            { className: 'addpost-button', onClick: this._onAddPostClickHandler },
	            'Send'
	          )
	        ),
	        this.state.data.map(function (item, i) {
	          return _react2['default'].createElement(_PostJsx2['default'], { postData: item, key: i });
	        }).reverse()
	      );
	    }
	  }]);
